...
- [ ] Сітка для малювання emoji
- [ ] Палітра emoji
- [ ] Кастомні палітри
- [ ] Створення / перейменування / видалення палітр
- [ ] Додавання своїх emoji в палітру
- [ ] Зміна порядку emoji
- [ ] Збереження палітр у localStorage
- [ ] Малювання кліком
- [ ] Малювання затиснутою мишкою
- [ ] Гумка
- [ ] Заливка
- [ ] Прямокутне виділення
- [ ] Копіювання виділення
- [ ] Вставка виділення
- [ ] Переміщення виділення
- [ ] Дублювання виділення
- [ ] Готові елементи з кількох клітинок
- [ ] Створення власного елемента з виділення
- [ ] Бібліотека збережених елементів
- [ ] Вставка елемента одним кліком
- [ ] Undo / Redo
- [ ] Масштаб сітки
- [ ] Зміна розміру полотна
- [ ] Clear
- [ ] Copy готового арту як текст
- [ ] Export / Import